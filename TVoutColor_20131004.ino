...
const char string_0[] PROGMEM =  " You can check and  ";     /* 1    */
const char string_1[] PROGMEM =  "adjust each color.  ";     /* 2    */
const char string_2[] PROGMEM =  " 0:White            ";     /* 3    */
const char string_3[] PROGMEM =  " 1:Green            ";     /* 4    */
const char string_4[] PROGMEM =  " 2:Blue             ";     /* 5    */
const char string_5[] PROGMEM =  " 3:Magenta          ";     /* 6    */
const char string_6[] PROGMEM =  " 4:Cyan             ";     /* 6    */
const char string_7[] PROGMEM =  " 5:Yellow           ";     /* 7    */
const char string_8[] PROGMEM =  " 6:Red              ";     /* 8    */
const char string_9[] PROGMEM =  " 7:Black            ";     /* 9    */
const char string_10[] PROGMEM = "up:Q,W,E,P          ";     /* 10   */
const char string_11[] PROGMEM = "down:A,S,D,F        ";     /* 11   */
